...
```sh
 git clone https://github.com/harshitajain06/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/harshitajain06/hello-rails-react/issues).
